 ...
 * @param {{ format?: "png"|"jpeg", quality?: number, background?: string, localization?: { strings: object, locale: string, direction: string } }} [options]
 */
export async function renderScreenshot(
  ...
  // Inject localized strings and set lang/dir before rendering
