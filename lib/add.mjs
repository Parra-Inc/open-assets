...
export async function addCollection(projectDir, configName) {
  ...
  let id, label, sourceSize, borderRadius, format, tags, exportList, outputs, templateDir, templateName, templateLabel;
  ...
  if (preset.value === "custom") {
    ...
    outputs = format === "svg" ? [{ type: "copy-source", format: "svg" }] : undefined;
  ...
  if (outputs) collection.outputs = outputs;
