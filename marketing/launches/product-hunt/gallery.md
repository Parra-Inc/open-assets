...
the CLI itself. Upload the 2x exports from `exports/gallery/ph-2x/`.
...
| Slot | File | Caption |
|------|------|---------|
| 1 | `ph-2x/01-hero.png` | One source of truth for your app's screenshots, icons, and favicons. Design in HTML, render at every size, export everywhere. |
| 2 | `ph-2x/02-dev-server.png` | A Storybook-style dev server with hot reload, zoom and pan, and one-click exports. |
